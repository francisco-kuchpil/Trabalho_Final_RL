...
Depois, criamos a variável decay, que é igual a 1 - 0.9 * progress, demodo que ela varia de 1 a 0.1 conforme vamos avançando no treinamento. Multiplicamos todas os parâmetros de mutação por elas. Ou seja, diminuimos progressivamente a probabilidade de cada mutação ao longo do treino, além da força das mutações.
